...
class BeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bee" do
    assert_difference('Bee.count') do
      post bees_url, params: { bee: { address: @bee.address, description: @bee.description, name: @bee.name, picture: @bee.picture } }
    end
  ...
  test "should update bee" do
    patch bee_url(@bee), params: { bee: { address: @bee.address, description: @bee.description, name: @bee.name, picture: @bee.picture } }
